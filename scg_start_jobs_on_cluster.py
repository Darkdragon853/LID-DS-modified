            ...
            for back_dataset in back_to_dataset:
                for freeze in freezing:
                    for scenario in scenario_names:
                        ...
                        command = f'sbatch --job-name=scg{job_counter:03} evaluation_scg.job {version} {scenario} {play_back_count} {result_path} {back_dataset} {freeze}'
