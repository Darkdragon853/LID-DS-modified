...
if __name__ == '__main__':
    ...
    false_alarm_recording_list = [recording for recording in test_data if os.path.basename(recording.path) in basename_recording_list]
    

    containerList = []
    for alarm in false_alarm_list: # TODO: Hier muss ich den Parameter p applyen
