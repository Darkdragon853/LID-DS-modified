...
class AE(BuildingBlock):
    ...
    the decision engine
    """
    def __init__(self, input_vector: BuildingBlock, mode: AEMode = AEMode.LOSS, learning_rate = 0.001, batch_size=256, max_training_time=600, early_stopping_epochs=50):
        super().__init__()                
