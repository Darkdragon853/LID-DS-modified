...
if __name__ == '__main__':
    ...
    pprint("Performing Host-based Intrusion Detection with SCG:")
    ...
    decision_engine = StreamSum(scg, True, window_length)
    ...
    # Preparing results
    config_name = f"algorithm_scg_n_{ngram_length}_w_{window_length}_t_{thread_aware}"

    # Enrich results with configuration
    results['algorithm'] = 'scg'
    ...
    result_path = f"{args.results}/results_scg_{args.version}_{args.scenario}.json"
    ...
    algorithm_name = f"scg_retrained"
