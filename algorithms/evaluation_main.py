...
if __name__ == '__main__':
    ...
    for counter in tqdm(range(len(false_alarm_list)), description, unit=' False Alarms'): # TODO: Bessere Zahlen finden als die  Liste der False-Alerts, da der -p Parameter hier ne Rolle spielt.
        ...
        if thread_aware:
            ...
            if backwards_counter != 0:
                ...
                while(not enough_calls(dict, ngram_length) and backwards_counter != 0):
                    ...
                    if current_call.thread_id() in dict.keys() and dict[current_call.thread_id()] < ngram_length:
    ...
    #containered_recordings = [Container(ids, recording) for recording in test_data] # TODO: Warum funktioniert das auch so hier? Die alten IDS werden ja nicht noch extra nochmals trainiert.
